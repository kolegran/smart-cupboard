...
docker pull kolegran/smart-cupboard-frontend

docker rm -f smart-cupboard-pg smart-cupboard-backend smart-cupboard-frontend mosquitto-broker
...
docker run -d --network smart-cupboard-net -e "VIRTUAL_HOST=smart-cupboard.kolegran.com" -e "LETSENCRYPT_HOST=smart-cupboard.kolegran.com" -e "LETSENCRYPT_EMAIL=kolegran@gmail.com" --name smart-cupboard-frontend kolegran/smart-cupboard-frontend
