...
docker run -d --network smart-cupboard-net -p 8080:8080 -e DB_HOST=smart-cupboard-pg -e DB_PORT=5432 --name smart-cupboard-backend kolegran/smart-cupboard-backend:1.0